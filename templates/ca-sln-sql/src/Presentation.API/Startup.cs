...
namespace Presentation.API
{
    ...
    public class Startup : StartupOrchestrator<AppStartupOrchestrator>
    {
        ...
        public Startup()
        {
            ...
            ServiceRegistrationExpressions.Add((services, config) => services.AddHealthChecksCustom());

            // AutoMapper
            ServiceRegistrationExpressions.Add((services, config) => services.AddSingleton<Profile, PresentationProfile>());
        }
